...
fn test_ls_basic() -> Result<()> {
    ...
    assert!(result.contains("README.md"), "Missing README.md in ls output");
    assert!(result.contains("Cargo.toml"), "Missing Cargo.toml in ls output");
...
fn test_ls_with_pattern() -> Result<()> {
    ...
    assert!(result.contains("README.md"), "Pattern *.md should match README.md");
    assert!(!result.contains("Cargo.toml"), "Pattern *.md should NOT match Cargo.toml");
...
fn test_read_basic() -> Result<()> {
    ...
    assert!(result.contains("Hello, world!"), "Should read print statement");
...
fn test_grep_no_matches() -> Result<()> {
    ...
    assert!(result.is_empty() || !result.contains("main.rs"), 
...
fn test_glob_recursive() -> Result<()> {
    ...
    assert!(result.contains("test_lib.rs"), "Should find tests/test_lib.rs");
...
fn test_stats() -> Result<()> {
    ...
    assert!(result.contains("Files:") || result.contains("files"), 
            "Should show file count");
    assert!(result.contains("Directories:") || result.contains("directories"), 
...
fn test_quick() -> Result<()> {
    ...
    assert!(result.contains("STATS:") || result.contains("F"), 
...
fn test_understand_project() -> Result<()> {
    ...
    assert!(result.contains("QUICK OVERVIEW"), "Should have quick overview section");
    assert!(result.contains("SEMANTIC GROUPS"), "Should have semantic section");
    assert!(result.contains("STATISTICS"), "Should have statistics section");
