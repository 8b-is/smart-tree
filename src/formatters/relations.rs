...
use crate::relations::{FileRelation, RelationType, RelationAnalyzer};
use anyhow::Result;
...
impl DotRelationFormatter {
    pub fn format<W: Write>(
        ...
        for file in &files {
            ...
            writeln!(writer, "    \"{}\" [fillcolor=\"{}\"];", display_name, color)?;
        }
        ...
        for rel in analyzer.get_relations() {
            ...
            writeln!(writer, "    \"{}\" -> \"{}\" [style={}, color={}, label=\"{:?}\"];",
    ...
    pub fn format<W: Write>(
        ...
        for (file, relations) in file_relations {
            ...
            for rel_type in &[
                ...
                let typed_rels: Vec<_> = relations.iter()
        ...
        let coupled_count = analyzer.get_relations().iter()
            ...
            .count();
        let tested_count = analyzer.get_relations().iter()
