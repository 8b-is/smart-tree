...
impl FunctionMarkdownFormatter {
    ...
    fn generate_markdown(&self, functions: &[FunctionInfo], stats: &TreeStats) -> String {
        let mut output = String::new();
        
        // Header
        output.push_str("# 📚 Function Documentation\n\n");
    ...
    fn format_function(&self, output: &mut String, func: &FunctionInfo) {
        let visibility_emoji = if func.visibility == "public" { "🔓" } else { "🔒" };
